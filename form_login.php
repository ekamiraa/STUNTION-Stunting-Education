        ...
        <div class="container" data-aos="fade-up">
          <div class="row g-0">
            <div
              ...
              style="background-image: url(assets/img/login-form.jpg)"
            ></div>

            <div class="col-lg-7">
              <form
              action="forms/login.php?op=in"
              method="post"
              ...
              <div class="row gy-4">
                <div class="col-lg-12">
                  ...
                  <div class="col-lg-12">
                    <h4>
                      Belum punya akun? <a href="form_register.php">Register now</a>
                    </h4>
                  </div>
                </div>
              </form>
