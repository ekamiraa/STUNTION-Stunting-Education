      ...
      <section id="about" class="about">
        <div class="container" data-aos="fade-up">
          <div class="row gy-4">
            ...
            >
              <img
                src="assets/img/bg-hitung-stunting.jpg"
                class="img-fluid"
                alt=""
              />
            </div>
            <div class="col-lg-6 content order-last order-lg-first">
              <h3>About Us</h3>
              <p>
                (STUNTION) Stunting Education adalah sebuah website yang
                menyediakan informasi tentang stunting. Dilengkapi dengan fitur
                pemeriksaan status gizi serta rekomendasi makanan bergizi.
              </p>
              <ul>
                <li data-aos="fade-up" data-aos-delay="100">
                  <i class="bi bi-diagram-3"></i>
                  <div>
                    <h5>Pengetahuan Tentang Stunting</h5>
                    <p>
                      Pengetahuan mengenai apa itu stunting, ciri-ciri,
                      penyebab, hingga cara pencegahannya.
                    </p>
                  </div>
                </li>
                <li data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div>
                    <h5>Hitung Status Gizi Makanan</h5>
                    <p>
                      Menghitung status gizi buah hati Anda untuk mnegetahui
                      apakah masuk kategori stuntig atau tidak
                    </p>
                  </div>
                </li>
                <li data-aos="fade-up" data-aos-delay="300">
                  ...
                  <div>
                    ...
                    <p>
                      Berisi rekomendasi makanan bergizi yang mudah untuk dibuat
